...
export const selectCartTotal = createSelector([selectCartItems],(cartItems) => cartItems.reduce((totalValue, cartItem) => totalValue + cartItem.price*cartItem.quantity, 0) )
